...
<div id="maindiv">
    ...
    <div class="d2"></div>
			    ...
			    <div class="d3w" style="margin-top:20px; margin-left:20px;">
				        <label style="color:rgb(56, 1, 34);font-size:35px;font-weight:bold;text-align:center">Dashboard,</label>
			    </div>
				<br><br><br>
			<div class="menu">
				...
				<div class="mcd3">
					...
					<a href="slogin.jsp" style="text-decoration: none; color: rgb(103, 12, 88); margin-left: 1%;" class="mcd33"><h4>Back to Student Login</h4></a>
